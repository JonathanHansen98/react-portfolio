    ...
    <div>
      <Row style={{backgroundColor: '#202020'}} className='py-3 mx-0'>
        <Col xs='auto'>
          ...
          <a href="https://drive.google.com/file/d/1utF0VM1j397CGQ6eoEyt0yncbuRUWVH5/view?usp=sharing"><FontAwesomeIcon color='#ebebe3' className='my-2 mx-3 hvr-forward' icon={faFilePdf} size='3x' /></a>
        </Col>
      </Row>
    </div>
  )
